...
exports.create = exports.readById = exports.read = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, Profile_1.Profile.findById(id)];
            case 1:
                data = _a.sent();
                res.json(data);
                return [3 /*break*/, 3];
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nickname, email, profile, err_2;
        ...
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, Profile_1.Profile.findOne({
                        $or: [{ email: email }, { $and: [{ 'nickname': { $exists: true, $ne: null } }, { nickname: nickname }] }],
                    }).exec()];
            case 1:
                profile = _b.sent();
                if (!!profile) return [3 /*break*/, 3];
                return [4 /*yield*/, Profile_1.Profile.create(__assign({}, req.body))];
            case 2:
                profile = _b.sent();
                res.json(profile);
                return [3 /*break*/, 4];
